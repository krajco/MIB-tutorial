...
static void usage(void) {
   printf("usage: agentxIOT [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main (int argc, char **argv) {
  ...
  while ((ch = getopt(argc, argv, "D:fHLM-:x:")) != EOF)
    ...
    case 'H':
      ...
      init_agent("agentxIOT");        /* register our .conf handlers */
      init_agentxIOT();
      init_snmp("agentxIOT");
  ...
  init_agent("agentxIOT");

  /* init agentxIOT mib code */
  init_agentxIOT();
