...
------------------------------------------------------------------------
  ...
  the iotUserTable table.  The agent will start by looking for the right
  ...
  file defaults/table-iotUserTable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      iotUserTable_allocate_data
      iotUserTable_release_data
 ...
 Index(es) for the iotUserTable table
  ------------------------------------------------------------
  The index(es) for the iotUserTable table are:
...
************************************************************************
iotUserTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the iotUserTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: iotUserTable_data_access.[c|h]
------------------------------------------------------------------------
  The iotUserTable_data_access file contains the interface to your data in
  ...
  FUNC : iotUserTable_indexes_set
  WHERE: iotUserTable_data_access.c
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the iotUserTable table.

To watch the flow of the iotUserTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        iotUserTable
        verbose:iotUserTable
        internal:iotUserTable

e.g.
        snmpd -f -Le -DiotUserTable,verbose:iotUserTable,internal:iotUserTable
...
/*---------------------------------------------------------------------
 * IOT-MIB::iotUserTableEntry.ROStringCol1
 * ROStringCol1 is subid 1 of iotUserTableEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.3.9999.2.1.1.1
 * Description:
Just a test label for table
 *
 * Attributes:
